...
import numpy as np
def extract_feat_vgg(img, backbone_layers, feat_ids,num, bottleneck_ids=None, lids=None):
...
def extract_feat_res(img, backbone_layers, feat_ids,num, bottleneck_ids, lids):
    r""" Extract intermediate features from ResNet"""
    feats = []
    feats
    # Layer 0
